...
void checker_function(void)
{
	...
	OBJECT(cyclic_1,CYC0);
	OBJECT(cyclic_2,CYC2);
	OBJECT(cyclic_3,DEVCYC1);
	...
	OBJECT(interrupt_0,1);
	OBJECT(interrupt_1,12);
	OBJECT(interrupt_2,14);
	OBJECT(interrupt_3,2);
	OBJECT(interrupt_4,5);
	OBJECT(interrupt_5,7);
	OBJECT(interrupt_6,8);
	OBJECT(interrupt_7,9);
	...
	OBJECT(exception_0,1);
	OBJECT(exception_1,4);
